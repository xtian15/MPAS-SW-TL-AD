...
def run_sw_tlm(pt=1.E-3):
    ...
    with h5.File('/Users/xtian/model-output/sw-tlm-out.h5', 'w') as outfile:
        outfile.create_dataset('u', data=mpsw.u[0])
        outfile.create_dataset('u_tl', data=mpsw.u_tl[0])
        outfile.create_dataset('h', data=mpsw.h[0])
        outfile.create_dataset('h_tl', data=mpsw.h_tl[0])
